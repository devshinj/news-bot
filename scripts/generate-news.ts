...
import { summarizeNews, generateColumn } from '../src/lib/summarizeNews';
import type { WeeklyNewsData, NewsColumn } from '../src/lib/types';
...
const main = async (): Promise<void> => {
  ...
  try {
    ...
    try {
      column = await generateColumn(articles, 'weekly');
